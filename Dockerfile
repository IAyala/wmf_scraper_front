...
ARG REACT_APP_SUPERADMIN_USERNAME
ARG REACT_APP_SUPERADMIN_PASSWORD

ENV REACT_APP_API_KEY=$REACT_APP_API_KEY
ENV REACT_APP_ADMIN_USERNAME=$REACT_APP_ADMIN_USERNAME
ENV REACT_APP_ADMIN_PASSWORD=$REACT_APP_ADMIN_PASSWORD
ENV REACT_APP_SUPERADMIN_USERNAME=$REACT_APP_SUPERADMIN_USERNAME
ENV REACT_APP_SUPERADMIN_PASSWORD=$REACT_APP_SUPERADMIN_PASSWORD
